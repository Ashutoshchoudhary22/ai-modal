...
CREATE INDEX idx_dataset_sources_dataset ON dataset_sources(dataset_id);

CREATE TABLE dataset_processing_runs (
    id CHAR(36) PRIMARY KEY,
...
CREATE INDEX idx_dataset_processing_runs_version ON dataset_processing_runs(dataset_version_id);
CREATE INDEX idx_dataset_processing_runs_status ON dataset_processing_runs(status);
